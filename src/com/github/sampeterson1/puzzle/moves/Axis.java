...
public enum Axis {
	...
	SKL("SKL", new Vector3f(-1, 1, 1), 2 * Mathf.PI / 3),
	SKF("SKF", new Vector3f(1, 1, 1), 2 * Mathf.PI / 3),
	SKR("SKR", new Vector3f(1, 1, -1), 2 * Mathf.PI / 3),
	SKB("SKB", new Vector3f(-1, 1, -1), 2 * Mathf.PI / 3);
