...
public class MegaminxStickerPlacement implements FaceStickerPlacement {
	...
	*/
	...
	public float getMinY(int cubeSize, float drawSize) {
		return -drawSize * Mathf.MEGAMINX_UNIT_APOTHEM;
	}
	...
	private Line[][] createLines(int cubeSize, float drawSize) {
	...
	private float[][] partitionPoints(int cubeSize, float drawSize) {
