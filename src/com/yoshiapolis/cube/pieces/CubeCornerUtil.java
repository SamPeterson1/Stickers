...
public class CubeCornerUtil {
	...
	private static final int[][] positionArr_R = {
			{1, 2}, {2, 6}, {6, 5}, {5, 1},
			{0, 3}, {3, 7}, {7, 4}, {4, 0}
	};
	
	private static final int[][] positionArr_U = {
			{0, 3}, {3, 2}, {2, 1}, {1, 0},
			{4, 7}, {7, 6}, {6, 5}, {5, 4}
	};
	private static final int[][] positionArr_F = {
			{0, 1}, {1, 5}, {5, 4}, {4, 0},
			{2, 6}, {6, 7}, {7, 3}, {3, 2}
	};
	...
	private static final int[][] rotationArr_R = {
			{1, 1}, {2, 0}, {6, 1}, {5, 1},
			{0, 2}, {3, 2}, {7, 2}, {4, 0},
	};
	private static final int[][] rotationArr_U = {
			{0, 0}, {1, 0}, {2, 0}, {3, 0},
			{4, 0}, {7, 0}, {6, 0}, {5, 0},
	};
	private static final int[][] rotationArr_F = {
			{0, 1}, {1, 0}, {5, 1}, {4, 1},
			{2, 2}, {6, 2}, {7, 0}, {3, 2}
	};
	...
	public static void rotateCW(PuzzlePiece corner) {
		Color[] cpy = new Color[3];
		for(int i = 0; i < 3; i ++) cpy[i] = corner.getColor(i);
		for(int i = 0; i < 3; i ++) corner.setColor((i + 1) % 3, cpy[i]);
	}
