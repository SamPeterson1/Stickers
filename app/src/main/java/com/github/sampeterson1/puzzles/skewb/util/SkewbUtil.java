...
public class SkewbUtil {
	...
	private static final int[] lCenterPositions = new int[] {1, 5, 4};
	private static final int[] rCenterPositions = new int[] {2, 3, 5};
	private static final int[] bCenterPositions = new int[] {0, 4, 3};
	
	private static final int[] fCornerPositions = new int[] {0, 2, 5};
	private static final int[] lCornerPositions = new int[] {0, 5, 7};
	private static final int[] rCornerPositions = new int[] {5, 2, 7};
	private static final int[] bCornerPositions = new int[] {2, 0, 7};
	
	private static final int[][] fCornerRotations = new int[][] {{1, 1}, {0, 2}, {2, 0}, {5, 1}};
	private static final int[][] lCornerRotations = new int[][] {{4, 1}, {0, 0}, {5, 2}, {7, 1}};
	private static final int[][] rCornerRotations = new int[][] {{6, 1}, {5, 1}, {2, 0}, {7, 2}};
